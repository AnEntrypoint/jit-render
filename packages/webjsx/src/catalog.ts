...
export const webjsxComponentDefinitions = {
  Card: {
    props: z.object({
...
export type WebjsxProps<K extends keyof typeof webjsxComponentDefinitions> =
  z.output<(typeof webjsxComponentDefinitions)[K]["props"]>;
